...
Function SlcmAttendanceCard() {
  return (data, adapter) => SlcmAttendanceCardView(data: data, adapter: adapter);
}
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          // Image
          Image.network(
            slcmAttendanceAdapter['imageURL'],
          ...
          Padding(
            ...
            child: Text(slcmAttendanceAdapter['title'], style: titleStyle),
          ),
          ...
          Row(
            ...
            children: <Widget>[
              Expanded(
                  child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(slcmAttendanceAdapter['author'], style: authorStyle),
              )),
              Padding(
                padding: const EdgeInsets.only(right: 8, bottom: 8),
                child: Text(
                  slcmAttendanceAdapter['timestamp'].toString(),
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(slcmAttendanceAdapter['content'], style: contentStyle),
          ),
          ...
          Padding(
            ...
            child: FlatButton(
              ...
              onPressed: openWebView(slcmAttendanceAdapter['link'], context)
            ),
          ),
        ],
      ),
